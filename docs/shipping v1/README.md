...
**Scope:** [`ship-todo.md`](../../ship-todo.md) Phases 0–1 complete; human decisions **D1–D4** recorded; Phases 2–7 not yet executed  
...
- **Phase 4 (domains):** Cross-check stale URL rows in task-0.1 (`karama.thebay.ma/khobz`, `*.workers.dev`, `*.pages.dev`).
- **Phase 5 (GitHub readiness):** Execute task-0.2 deletion list; reconcile workflow/README topology rows in task-0.1.
- **Phase 7 (verification):** Re-run the search terms listed in task-0.1 and confirm task-0.2 acceptance (zero `* 2.*` files).
